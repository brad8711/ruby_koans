...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    ## Inject takes the yeild(value,result or return value)
    ## from the previous code block and makes it available for processing in the next iteration.
  end
  ...
  ## Answer: Because using a code block is quicker and cleaner, more succinct.
  ##         something to do with the file keyword and being able to use that in another code block.
end
